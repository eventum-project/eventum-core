...
def test_single_thread_state_get_for_update(
    single_thread_state: SingleThreadState
):
    key = 'test_key'
    value = 'test_value'
    single_thread_state.set(key, value)
    assert single_thread_state.get_for_update(key) == value


def test_single_thread_state_cancel_update(
    single_thread_state: SingleThreadState
):
    single_thread_state.cancel_update()
